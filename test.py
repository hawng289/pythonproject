...
X_new = vectorizer.transform(pd.Series(stemming(index.get_testdata('https://sports.ndtv.com/fifa-world-cup-2022/did-cristiano-ronaldo-head-ball-vs-uruguay-in-world-cup-game-fifa-has-this-to-say-3563389'))))
